          ...
          <a href="/" className="flex items-center gap-2 shrink-0">
            ...
            <div className="hidden sm:flex flex-col leading-none gap-1">
              ...
              <div className="flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 rounded-full bg-[#ef4444] animate-pulse shrink-0" />
                <span className="text-[9px] text-[#fca5a5] font-bold uppercase tracking-widest">Wholesale Portal</span>
              </div>
            </div>
          </a>
